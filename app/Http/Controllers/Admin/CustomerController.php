...
class CustomerController extends Controller implements HasMiddleware
{
    ...
    {
        $agents = User::role('Agents')->get();
        return view('admin.customer.create',compact('agents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $user = new User();
            $user->user_id = generateUniqueId('customer');
            ...
            if($res){
                ...
                return back()->with('success','Customer Not Added');
            }
        }
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.customer.edit',compact('user','business_categorys'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($validator->fails()) {
            ...
            if($res){
                ...
                return back()->with('success','Customer Not Updated');
            }
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        if($res){
            ...
            return back()->with(['error'=>'Customer Not Deleted']);
        }
    }
}
