        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ul class="nav nav-tabs page-header-tab">
                    ...
                    @can('Agents Create')
                    <li class="nav-item"><a class="btn btn-info" href="{{ route('agents.create') }}"><i class="fa fa-plus"></i>Create Agents</a></li>
                    @endcan
                </ul>
            </div>
        </div>
                                ...
                                <table class="table table-hover js-basic-example dataTable table-striped table_custom border-style spacing5">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th></th>
                                            @canany(['Agents Edit','Agents Delete'])
                                            <th>Action</th>
                                            @endcanany
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w60">
                                                <img class="avatar" src="{{ $user->getFirstMediaUrl('agents-image') }}" alt="">
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('agents.show',$user->id) }}" class="btn btn-icon btn-sm" title="View"><i class="fa fa-eye"></i></a>
                                                @can('Agents Edit')
                                                <a href="{{ route('agents.edit',$user->id) }}" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                                @endcan
                                                @can('Agents Delete')
