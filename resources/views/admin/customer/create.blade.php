        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ul class="nav nav-tabs page-header-tab">
                    ...
                    <li class="nav-item"><a class="btn btn-info" href="{{ route('customers.index') }}"><i class="fa fa-arrow-left me-2"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Agent <span class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <select class="form-control input-height" name="agent" required>
