        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ul class="nav nav-tabs page-header-tab">
                    ...
                    @can('User Create')
                    <li class="nav-item"><a class="btn btn-info" href="{{ route('customers.create') }}"><i class="fa fa-plus"></i>Add User</a></li>
                    @endcan
                </ul>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('transactions',$user->id) }}"
                                            ...
                                            {{-- <td>
                                                <a href="{{ route('customers.show',$user->id) }}" class="btn btn-icon btn-sm" title="View"><i class="fa fa-eye"></i></a>
                                                @can('Auditor Edit')
                                                <a href="{{ route('customers.edit',$user->id) }}" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                                @endcan
                                                @can('Auditor Delete')
